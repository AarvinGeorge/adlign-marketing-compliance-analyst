# Shiboleth PRD v1 (2026-07-09)

> The product requirements document for MVP v1. Captures the full intent and mission. Companion artifacts: `01_spec_v1_2026-07-09.md` (technical spec), `DESIGN.md` (UI contract), `02_handoff_to_claude_code_v1_2026-07-09.md` (build handoff), `04_trial_context_shiboleth_2026-07-08.md` (living context), `05_shibboleth_problem_context_and_scorecard_2026-07-09.md` (canonical scorecard + problem statement), `design-files/Shiboleth-marketing-compliance-checker-v1/` (prototype, UX Version 2), `03_design_handoff_shiboleth_v2_2026-07-08.pdf` and `03_design_delta_shiboleth_v2.2_2026-07-09.pdf` (design references).

## 1. Mission and intent

Shiboleth is a continuous marketing-compliance monitoring product for compliance analysts at fintechs whose bank partners require their marketing to comply with a defined scorecard. It flags violations across large volumes of live marketing material (websites, social), with cited evidence, human disposition, and defensible scoring.
...
**Out of v1 (data modeled day 1, UI/feature day 2+):** PDF export, screenshots + positioned pins, insights tab, view toggle, full audit accordion, Missing-flag UI, audit-the-library, daily cron, auto-verify closure, Shiboleth MCP server, sidebar collapse. Email is completely out of scope (Aarvin, 2026-07-09).
